...
# Path: OurLibrary/Source/Core/DriveManager.py
# Standard: AIDEV-PascalCase-2.1
# Created: 2025-07-12
# Last Modified: 2025-07-23 10:30PM
"""
Description: Central manager for Google Drive database synchronization in OurLibrary
...
# Import OurLibrary modules - fix path issues
import sys
import os
...
class DriveManager:
    ...
    def __init__(self, config_path: str = "OurLibrary/Config/andygoogle_config.json"):
        self.config_path = config_path
        self.config = self.LoadConfig()
        
        # Initialize API components
        credentials_path = self.config.get('google_credentials_path', 'OurLibrary/Config/google_credentials.json')
        self.drive_api = GoogleDriveAPI(credentials_path)
        self.sheets_logger = SheetsLogger(credentials_path)
        
        # Local paths
        self.local_db_path = self.config.get('local_database_path', 'OurLibrary/Data/Local/cached_library.db')
        self.backup_db_path = self.config.get('backup_database_path', 'OurLibrary/Data/Local/backup_library.db')
        self.version_info_path = "OurLibrary/Data/Local/version_info.json"
    ...
    def LoadConfig(self) -> Dict[str, Any]:
        ...
        default_config = {
            'google_credentials_path': 'OurLibrary/Config/google_credentials.json',
            'local_database_path': 'OurLibrary/Data/Local/cached_library.db',
            'backup_database_path': 'OurLibrary/Data/Local/backup_library.db',
    ...
    def InitializeDatabase(self) -> bool:
        ...
        print("🚀 Initializing OurLibrary database...")
        ...
        if self.SyncDatabaseFromDrive(force_download=True):
            ...
            if os.path.exists(self.local_db_path):
                ...
                print("❌ No database available - OurLibrary cannot start")
                return False
